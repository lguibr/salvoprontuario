  ...
  return (
    <div className="absolute inset-0 bg-black/40 z-50 flex items-center justify-center p-4 print:hidden backdrop-blur-sm">
      <div className="bg-nt-paper w-full max-w-4xl rounded-2xl shadow-2xl border border-nt-border overflow-hidden flex flex-col max-h-[90vh]">
        <div className="p-5 border-b border-nt-border flex justify-between items-center bg-white shrink-0">
          ...
          <div className="bg-nt-paper border border-nt-border rounded-xl p-4 flex flex-col md:flex-row gap-6 items-start md:items-center">
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 leading-relaxed max-w-lg">
                Faça upload da imagem do seu carimbo (PNG ou JPG). Esta imagem será anexada automaticamente no formato docx exportado no final das consultas.
              </p>
            </div>
            <div className="flex flex-col items-center gap-3 w-full md:w-auto">
              {stampImage ? (
                <div className="relative group border border-nt-border rounded bg-white p-2 w-[200px] h-[100px] flex items-center justify-center shadow-inner">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="flex flex-col flex-1">
              ...
              <textarea 
                ...
                className="w-full text-xs font-mono p-4 border border-nt-border rounded-xl resize-none h-[300px] lg:h-[400px] focus:outline-none focus:ring-2 focus:ring-nt-primary/50 focus:border-nt-primary bg-white leading-relaxed text-gray-700 hover:border-nt-primary/50 transition-colors"
